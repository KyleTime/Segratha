...
compile:
	g++ -c src/*.cpp src/CaveSand/*.cpp src/CaveSand/Pixels/*.cpp src/Game/*.cpp src/Game/Components/*.cpp src/KGenerics/*.cpp -IC:\libraries\SFML-2.5.1\include -DSFML_STATIC
